...
const Footer = (props) => {
  ...
  return (
    <div
      className={cn(
        "grid grid-cols-1 md:grid-cols-3 gap-x-5 gap-y-5 lg:gap-x-10 mt-10",
        className
      )}
    >
      <div>
        ...
        <p className="text-gray-600 mt-4 leading-6 text-sm">
          ...
          for professional advice for your new business.
        </p>
      </div>
      ...
      <div>
        ...
        <div className="text-gray-600 mt-4 leading-6 text-sm">
          <ul className="list-disc">
            ...
            <li> Digital content marketing online clients plateform</li>
            <li> Safe secure services for you online email account</li>
          </ul>
        </div>
      </div>
      <div>
